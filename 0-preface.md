...
So this preface does three things, in a deliberate order that saves the most important for last. First, it credits the people and the ideas that made the work possible, because none of it was done alone. Second, and most warily, it sketches the peculiar life that produced the particular lens these essays are seen through. Third, and at greatest length, it explains how the essays were actually made: the method, the sources, the machine, and the disciplines meant to keep all three honest. But before any of that, two words need pinning down.
