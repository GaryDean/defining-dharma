...
- Takashi Shiraishi, "Dangir's Testimony: Saminism Reconsidered," *Indonesia* 50 (1990): 95–120 — the 1928 interrogation minutes, the nearest thing to a Samin first-person source; "Samin" as the state's label for the self-named *wong sikep*; the movement as partly an artifact of the colonial file, the millenarian evidence as partly spy-mediated, and the Samin doctrine of language.
