...
The Samin were one. Now I want to pull back and show you the range, because the plurality this series keeps insisting on is not an abstraction. It is a real and sometimes dizzying fact about the human world. So we are going to visit four dharmas that grew up far apart, look at each on its own terms, and only then ask what, if anything, holds across them. Watch, as we go, where each one draws its circle of care, who it gathers in and who it leaves outside.

I am going to end the tour with the one many of you were raised inside, the family of Jewish, Christian, and Muslim ethics, and I should say why. The whole wager of this series is that we can look at dharmas without privileging any of them, including our own. That is easy to say about somebody else's tradition and hard to do about the water you were swimming in before you could see it. So the Abrahamic covenant comes last, as the real test of whether the non-privileging eye can be turned around to look at itself.
